...
// 🌟 مسحنا الـ Imports المتكررة، وسيبنا المسار الصحيح بس
...
class ReportsFragment : Fragment() {
    ...
    // 2. كتابة الأكواد والمنطق هنا
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        // 🌟 تعديل آمن: طبقنا الـ Insets على الـ view الأساسي مباشرة عشان نمنع أي كراش
        ...
        // زرار إنشاء التقرير الخاص بالصفحة دي 
