...
import androidx.appcompat.widget.SwitchCompat  // ✅ غيري هنا
...
class AlarmAdapter : RecyclerView.Adapter<AlarmAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val switchAlarm: SwitchCompat = itemView.findViewById(R.id.switch_alarm)  // ✅ غيري هنا
        ...
        fun bind(alarm: Alarm) {
            ...
            chipCategory.text = alarm.category
